                  ...
                  <div class="blog-listing-content">
                        <h3 class="title animated fadeIn">
                            ...
                            if (strpos($full_title, ' ') !== false) {
                                ...
                                // Output with the first word underlined
                                echo '<b><span class="blue-underline">' . $first_word . '</span> ' . $rest_of_title . '</b>';
                            } 
                            // If there are no spaces, handle as before
                            else {
                                ...
                                if ($title_length >= 3) {
                                    ...
                                    $first_two = mb_substr($full_title, 0, 2);
                                    $rest_of_title = mb_substr($full_title, 2);
                                    echo '<b><span class="blue-underline">' . $first_two . '</span>' . $rest_of_title . '</b>';
                                }
