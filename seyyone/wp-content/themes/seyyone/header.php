...
<header class="header-style-one" style="box-shadow: 0px 7px 18px rgba(24, 16, 16, 0.0509803922);  background-color: #f0f8fff7">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<header class="header-style-one header--sticky" style=" background-color: #f0f8fff7;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="header-wrapper-1">
