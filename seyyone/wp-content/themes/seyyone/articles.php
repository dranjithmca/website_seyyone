        ...
        <div class="row g-5 mt-4">
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-offset="120"<?php echo $delay_attr; ?> id="<?php echo esc_attr($post_id); ?>">
                <div class="single-blog-area-start border-none mb--30">
                    <a href="<?php echo esc_url(home_url('/article-details/?id=' . urlencode($post_id))); ?>" class="thumbnail">
                        <div class="blog_img">
                    ...
                    <div class="inner-content-area">
                        <div class="top-area">
                            <a href="<?php echo esc_url(home_url('/article-details/?id=' . urlencode($post_id))); ?>">
                            ...
                            <div class="button-area-right-header">
                                <a href="<?php echo esc_url(home_url('/article-details/?id=' . urlencode($post_id))); ?>" class="rts-btn btn-border">
                                    Read More
                                </a>
            ...
            <div class="col-12">
                <div style="text-align: center; padding: 60px 20px; background: #f8f9fa; border-radius: 15px; border: 2px dashed #dee2e6;">
                    ...
                    <h3 style="color: #495057; margin-bottom: 15px;">No Articles Found</h3>
                    <p style="color: #6c757d; margin-bottom: 25px;">We'll be adding new content soon. Check back later!</p>
                    
                    <?php if (current_user_can('edit_posts')) : ?>
                        <a href="<?php echo admin_url('post-new.php?post_type=seyyone_article'); ?>" class="rts-btn btn-primary">
                            <i class="fa fa-plus" style="margin-right: 8px;"></i>Add New Article
                        </a>
                    <?php endif; ?>
                </div>
            </div>
